...
import mainEmoji from "@/public/Emoji-1.png"
import Memoji2 from "@/public/Memoji2.png"
import FemaleMemoji from "@/public/Female Memojis.png"
import Memoji4 from "@/public/Memoji4.png"
import Memoji5 from "@/public/Memoji5.png"
import Memoji6 from "@/public/Memoji6.png"
import Memoji8 from "@/public/Memoji8.png"
...
>(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-12 items-center justify-center rounded-full  bg-white shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
                className,
            )}
...
export default function AnimatedBeamDemo() {
    ...
    return (
        <div
            ...
            ref={containerRef}
        >
            <div className="flex size-full flex-col max-w-lg max-h-[250px] items-stretch justify-between gap-10">
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div1Ref}>
                        <Image alt="sa" src={Memoji2}></Image>
                    </Circle>
                    <Circle ref={div5Ref}>
                        <Image alt="sa" src={FemaleMemoji}></Image>
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div2Ref}>
                        <Image alt="sa" src={Memoji4}></Image>
                    </Circle>
                    <Circle ref={div4Ref} className="size-16">
                        <Image alt="sa" src={mainEmoji}></Image>
                    </Circle>
                    <Circle ref={div6Ref}>
                        <Image alt="sa" src={Memoji5}></Image>
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div3Ref}>
                        <Image alt="sa" src={Memoji8}></Image>
                    </Circle>
                    <Circle ref={div7Ref}>
                        <Image alt="sa" src={Memoji6}></Image>
                    </Circle>
                </div>
            </div>
            ...
            <AnimatedBeam
                ...
                gradientStartColor="#45EA69"
                gradientStopColor="#45EA69"
